...
public void getPositionList(String date, final Activity act){
		...
		for (int i = 0; i < len; i++) {
			...
			String str_startt = cal_collection.start;
			String str_endt = cal_collection.end;
			
			if (date.equals(event_date)) {
			
			//Toast.makeText(context, "You have event on this date: "+event_date, Toast.LENGTH_LONG).show();
			alert.showAlertDialog(context, "Event date", "You have event on this date: "+event_date, true);
			 new AlertDialog.Builder(context)
	          .setIcon(android.R.drawable.ic_dialog_alert)
	           .setTitle("Date: "+event_date)
	            .setMessage("Title: "+event_message + "\n" + "Start time : "+str_startt+ "\n" +"End Time  : "+str_endt)
