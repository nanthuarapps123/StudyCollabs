...
public class BuilderManager {
    ...
    private static int[] textResources1 = new int[]{
            R.string.bat1,
            R.string.bear1,
            R.string.bee1,
            R.string.butterfly1
    ...
    private static int[] textResourcessub = new int[]{
            R.string.bat2,
            R.string.bear2,
            R.string.bee2,
            R.string.butterfly2
    ...
    private static int textResourceIndexsub = 0;
    ...
    static int gettextResource1() {
        if (textResourceIndex1 >= textResources1.length) textResourceIndex1 = 0;
        return textResources1[textResourceIndex1++];
    }

    static int gettextResourcesub() {
        if (textResourceIndexsub >= textResourcessub.length) textResourceIndexsub = 0;
        return textResourcessub[textResourceIndexsub++];
    }
    ...
    static HamButton.Builder getPieceCornerRadiusHamButtonBuilder() {
        return new HamButton.Builder()
                ...
                .subNormalTextRes(gettextResourcesub());
    }
